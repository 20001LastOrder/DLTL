...
/*package*/ class BinaryConnection_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new leftSingleRoleHandler_btqdx2_a0(myNode, LINKS.left$FDrO, getEditorContext());
  ...
  private EditorCell createProperty_0() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.connector$GmvM;
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new rightSingleRoleHandler_btqdx2_c0(myNode, LINKS.right$FDTQ, getEditorContext());
    return provider.createCell();
  }
  ...
  private static final class PROPS {
    /*package*/ static final SProperty connector$GmvM = MetaAdapterFactory.getProperty(0x490a9af6490e4908L, 0xabde38f69766a5e3L, 0x6a7de6ab4ec961e4L, 0x6a7de6ab4ec961eeL, "connector");
  }
