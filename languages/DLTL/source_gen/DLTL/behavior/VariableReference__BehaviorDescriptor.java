...
public final class VariableReference__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x91a99801f144985L, 0xb06a9c8c7ccee4a2L, 0x6a7de6ab4ec961f0L, "DLTL.structure.VariableReference");
  ...
  /*package*/ static String transform_idGAenPgHvX3(@NotNull SNode __thisNode__) {
    return SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.ref$VwU1), PROPS.name$MnvL);
  }
