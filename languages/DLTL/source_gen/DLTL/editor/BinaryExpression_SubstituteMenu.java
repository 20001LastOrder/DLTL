...
public class BinaryExpression_SubstituteMenu extends SubstituteMenuBase {
  ...
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_Param_2xlff3_a(), CONCEPTS.BinaryExpression$Fj));
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("default substitute menu for " + "BinaryExpression", new SNodePointer("r:50d4a098-ccf6-4468-b15f-c986c1a1d889(DLTL.editor)", "7673542963545469624")));
    try {
  ...
  private class SMP_Param_2xlff3_a extends ParameterizedMenuPart<SConcept, SubstituteMenuItem, SubstituteMenuContext> {
    ...
    public List<SubstituteMenuItem> createItems(@NotNull SubstituteMenuContext context) {
      context.getEditorMenuTrace().pushTraceInfo();
      context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("parameterized substitute menu part", new SNodePointer("r:50d4a098-ccf6-4468-b15f-c986c1a1d889(DLTL.editor)", "7673542963545476011")));
      try {
    ...
    protected Iterable<? extends SConcept> getParameters(SubstituteMenuContext _context) {
      return ListSequence.fromList(SConceptOperations.getAllSubConcepts2(CONCEPTS.BinaryExpression$Fj, _context.getModel())).where(new IWhereFilter<SConcept>() {
    ...
    private class SMP_Action_2xlff3_a0 extends SingleItemSubstituteMenuPart {
      ...
      protected SubstituteMenuItem createItem(SubstituteMenuContext _context) {
        ...
        try {
          _context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase(description, new SNodePointer("r:50d4a098-ccf6-4468-b15f-c986c1a1d889(DLTL.editor)", "7673542963545491398")));
      ...
      private class Item extends DefaultSubstituteMenuItem {
        ...
        public Item(SubstituteMenuContext context) {
          super(CONCEPTS.BinaryExpression$Fj, context);
          _context = context;
        }
        ...
        public SNode createNode(@NotNull String pattern) {
          ...
          SLinkOperations.setTarget(instance, LINKS.left$CP7_, SLinkOperations.getTarget(_context.getCurrentTargetNode(), LINKS.left$CP7_));
          SLinkOperations.setTarget(instance, LINKS.right$CP_B, SLinkOperations.getTarget(_context.getCurrentTargetNode(), LINKS.right$CP_B));
          return instance;
        }
        ...
        protected CompletionItemInformation createInformation(String pattern) {
          return new CompletionItemInformation(myParameterObject, CONCEPTS.BinaryExpression$Fj, getMatchingText(pattern), getDescriptionText(pattern));
        }
        @Nullable
        @Override
