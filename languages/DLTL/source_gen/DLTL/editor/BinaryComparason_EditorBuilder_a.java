...
/*package*/ class BinaryComparason_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public BinaryComparason_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_y6hict_a");
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new leftSingleRoleHandler_y6hict_a0(myNode, LINKS.left$CP7_, getEditorContext());
    return provider.createCell();
  }
  private static class leftSingleRoleHandler_y6hict_a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public leftSingleRoleHandler_y6hict_a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createProperty_0() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.comparator$Dc5E;
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new rightSingleRoleHandler_y6hict_c0(myNode, LINKS.right$CP_B, getEditorContext());
    return provider.createCell();
  }
  private static class rightSingleRoleHandler_y6hict_c0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public rightSingleRoleHandler_y6hict_c0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_y6hict_d0");
    Style style = new StyleImpl();
