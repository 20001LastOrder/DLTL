...
/*package*/ class Model_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.import$owfh;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
  ...
  private EditorCell createProperty_2() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.method$7R72;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new parametersListHandler_pyq9q9_g0(myNode, getEditorContext());
  ...
  private static class parametersListHandler_pyq9q9_g0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public parametersListHandler_pyq9q9_g0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(parametersListHandler_pyq9q9_g0.this.getNode(), LINKS.parameters$mRRe));
      try {
