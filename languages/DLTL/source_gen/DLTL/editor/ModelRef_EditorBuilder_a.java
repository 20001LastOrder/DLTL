...
/*package*/ class ModelRef_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ModelRef_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_81u7o1_a");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.ref$2O4z;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.ref$2O4z);
    }
