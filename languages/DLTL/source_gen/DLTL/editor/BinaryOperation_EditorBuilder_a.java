...
/*package*/ class BinaryOperation_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new leftSingleRoleHandler_tdrdn7_a0(myNode, LINKS.left$CP7_, getEditorContext());
  ...
  private EditorCell createProperty_0() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.operator$DqaA;
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new rightSingleRoleHandler_tdrdn7_c0(myNode, LINKS.right$CP_B, getEditorContext());
    return provider.createCell();
  }
