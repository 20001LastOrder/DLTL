...
/*package*/ class DatasetRef_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public DatasetRef_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_34ln6g_a");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.ref$9om5;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.ref$9om5);
    }
